<template>
  <v-app>
    <v-app-bar app color="teal lighten-1" flat>
...
let mockData = [
  {
    id: 1,
    title: "The New Manager's Handbook",
  ...
  {
    id: 2,
    title: "Fun with Advanced Mathematics",
    author: "Lewis Galoo",
    isbn: "NULL          ",
    copies: 3,
    available: 1,
  ...
  {
    id: 3,
    title: "Fun with Further Mathematics",
    author: "Lewis Galoo",
    isbn: "NULL          ",
    copies: 5,
    available: 1,
  ...
  {
    id: 4,
    title: "Learn how to be a Demolition Expert",
    author: "Lewis Galoo",
    isbn: "NULL          ",
    copies: 1,
    available: 0,
  ...
  {
    id: 5,
    title: "Learn how to be a Dolphin Trainer",
    author: "Lewis Galoo",
    isbn: "NULL          ",
    copies: 1,
    available: 1,
  ...
  {
    id: 6,
    title: "Learn how to be an Astronaut",
    author: "Lewis Galoo",
    isbn: "NULL          ",
    copies: 2,
    available: 0,
  ...
  {
    id: 7,
    title: "Learn how to be a Supermodel",
    author: "Lewis Galoo",
    isbn: "NULL          ",
    copies: 1,
    available: 1,
  ...
  },
  {
    ...
    author: "William Strunk Jr.,  E. B. White,  William Strunk",
    isbn: "020530902X    ",
    copies: 1,
    available: 1,
  },
  {
    id: 10,
    title:
      "Selenium Simplified - Automated Web Testing with Java and Selenium RC 2nd edition",
  ...
  {
    id: 12,
    title: "Software Testing:  An ISEB Foundation",
    author:
      "Brian Hambling, Peter Morgan, Angelina Samaroo, Geoff Thompson, Peter Williams",
    isbn: "1906124760    ",
    copies: 1,
    available: 0,
  },
  ...
  {
    id: 28,
    title: "Special Edition Using Microsoft Commerce Server 2002",
  ...
  {
    id: 34,
    title: "Taste Test - Puppet Chef Salt Ansible",
    author: "Matt Jaynes",
    isbn: "              ",
    copies: 1,
    available: 1,
  ...
  },
  {
    ...
    author:
      "Jon Galloway, Phil Haack, Scott Hanselman, Scott Gutherie, Rob Conery",
    isbn: "470643188     ",
    copies: 1,
    available: 1,
  },
